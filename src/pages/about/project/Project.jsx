...
import img from "@/assets/photoofall.jpg"; // TODO: Delete
  ...
  const UI = {
    ...
    ru: {
      ...
      jashStory: [
        ...
        и ресурсы для эффективного обучения.`,
        <br/>,<br/>,
        ...
        мотивом для продолжения работы.`,
        <br/>,<br/>,
        
        `Многие участники команды — победители и призеры различных олимпиад
        по истории, что подтверждает высокий уровень их знаний.`,
        <br/>,<br/>,
    ...
    kg: {
      aboutTheProject: "ДОЛБООР ЖƟНYНДƟ", // Using special symbols, font still works.
      jashStory: [
        `Jash Story – бул кыргыз жана дүйнөлүк тарыхты изилдөөнү айкалыштырган
        билим берүү долбоору. Биз мектеп олимпиадаларын уюштурабыз, даярдык
        материалдарын иштеп чыгабыз жана пайдалуу китептерге мүмкүнчүлүк беребиз.
        Биздин веб-сайт ар бир адам натыйжалуу окутуу үчүн терең маалымат жана
        ресурстарды таба турган платформага айланат.`,
        <br/>,<br/>,
        
        `Долбоор тарыхка кызыккан жана өз билимдерин башкалар менен бөлүшүүнү
        чечкен өспүрүмдөр тарабынан түзүлгөн. Алар Instagram баракчасы менен
        баштаганда, эбегейсиз колдоого ээ болуп, ишин улантууга түрткү беришкен.`,
        <br/>,<br/>,
        
        `Команданын көптөгөн мүчөлөрү ар кандай тарыхый олимпиадалардын жеңүүчүлөрү
        жана байге ээлери болуп, өздөрүнүн жогорку билим деңгээлин тастыктап жатышат.`,
        <br/>,<br/>,
        
        `Jash Story билимин тереңдетип, тарыхты жакшыраак түшүнгүсү келген ар бир
        адам үчүн жеткиликтүү болгон уникалдуу жана пайдалуу материалдарды сунуштайт.`,
      ],
    },
  }
  const { aboutTheProject, jashStory } = UI[language];
